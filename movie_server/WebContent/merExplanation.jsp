...
<html>
	...
	<head>
		...
		<link href="merCss/style.css" rel="stylesheet" type="text/css" />
			...
			<div class="box-module height100b margin0">
				...
				<div class="box-content padding15">
			        ...
			        <p class="margin"> <b class="color2">设置参数值[2]</b></p><p class="margin"> });</p>
						...
						<div><img src="merImages/stencil/image.jpg" width="100%"></div>
					</div>
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<div class="l_f mr20"><img src="merImages/stencil/image.png" width="200px">
										<p>当显示位置在左侧时界面样式</p>
									</div>
									<div class="l_f"><img src="merImages/stencil/image1.png" width="360px">
										<p>当显示位置在顶部时界面样式</p>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>菜单展开用的图标，只适合用字体图标，不限于字体库的名称<p class="l_f"><img src="merImages/stencil/image2.png" width="100px"></p></td>
							</tr>
							<tr>
								<td class="text-center">mouIconClose</td>
								<td class="text-center">隐藏</td>
								<td class="text-center color4">自定义（字体库图标名）</td>
								<td>菜单隐藏用的图标，只适合用字体图标，不限于字体库的名称<p class="l_f"><img src="merImages/stencil/image2.png" width="100px"></p></td>
							</tr>
							<tr>
								<td class="text-center">iconsort</td>
								<td class="text-center">图文</td>
								<td class="text-center color4">自定义（字体库图标名）</td>
								<td><p class="l_f"><img src="merImages/stencil/image3.png" width="100px"></p>  设置菜单栏显示模式为图文模式下的样式</td>
							</tr>
							<tr>
								<td class="text-center">iconsortg</td>
								<td class="text-center">图标</td>
								<td class="text-center color4">自定义（字体库图标名）</td>
								<td><p class="l_f"><img src="merImages/stencil/image4.png" width="40px"></p> 设置菜单栏显示模式为图标模式下的样式</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="text-center color4">自定义</td>
								<td><p class="l_f"><img src="merImages/stencil/image6.png" width="200px"></p>皮肤选择时显示的图标</td>
							</tr><tr>
								<td class="text-center">Bombboxinfo</td>
								<td class="text-center">消息盒子</td>
								<td class="text-center color4">自定义</td>
								<td><p class="l_f"><img src="merImages/stencil/image7.png" width="200px"></p>用于设置消息盒子显示层样式</td>
							</tr>
							<tr>
								<td class="text-center">boxname</td>
								...
								<td>
									<p class="l_f"><img src="merImages/stencil/image8.png" width="200px"></p>
