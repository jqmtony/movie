 ...
 <!--//main-header-->
	...
	<div class="breadcrumb-inner">	
			<ul>
				...
				<li><a href="News.jsp">News</a><i>//</i></li>
				<li>Single</li>
			</ul>
		</div>
	</div>
